...
use App\Models\User;
use App\Providers\EntityProvider;
...
class PermissionApplicator
{
    ...
    public function checkOwnableUserAccess(OwnModel $ownable, string $permission): bool
    {
    ...
    protected function hasEntityPermission(Entity $entity, array $userRoleIds, string $action): ?bool
    {
        ...
        // TODO: EntityPermissionEvaluator class
    ...
    public function checkUserHasEntityPermissionOnAny(string$action, string $entityClass = ''): bool
    {
        ...
        $permissionQuery = EntityPermission::query()
            ->where($action, '=', true)
            ->where('role_id', '=', $this->getCurrentUserRoleIds());
