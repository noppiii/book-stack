...
class MfaSession
{
    ...
    // Check if the given user is pending MFA setup. (MFA required but not yet configured).
    ...
    public function userRoleEnforcesMfa(User $user): bool
    {
        return $user->roles()->where('mfa_enforced', '=', true)->exists();
    }
